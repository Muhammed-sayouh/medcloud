...
class CountryCodePickerCustom extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return CountryCodePickerCustomState(elements);
  }
}

class CountryCodePickerCustomState extends State<CountryCodePickerCustom> {
  CountryCode? selectedItem;
  List<CountryCode> elements = [];
  List<CountryCode> favoriteElements = [];

  CountryCodePickerCustomState(this.elements);
                ...
                Flexible(
                  ...
                  child: Container(
                    ...
                    margin: widget.alignLeft
                        ? const EdgeInsets.only(right: 2, left: 5.0)
